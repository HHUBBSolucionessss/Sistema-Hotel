...
<?php $form = ActiveForm::begin(); ?>
    <div class"row">
            <div class="col-md-3">
                <?= $form->field($model, 'fecha_entrada')->textInput(['id'=>'_fecha_entrada','readonly'=>true]) ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($model, 'fecha_salida')->textInput(['id'=>'_fecha_salida','readonly'=>true]) ?>
            </div>
            <div class="col-md-3">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <?php
                    ...
                    'options' => ['placeholder' => 'Buscar huésped ...'],
                    'pluginOptions' => [
                        'allowClear' => true,
                ...
                <?php echo Html::a('<span class="glyphicon glyphicon-plus"> Nuevo</span>',
                        ['/huesped/nuevo'],
                        [
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
        <i class="fa fa-envelope" class="panel panel-success">Datos del huésped</i>
