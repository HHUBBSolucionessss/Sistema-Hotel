...
<div class="Tarifa-form">
    ...
    <div class="row">
        <div class="col-md-4">
            <?= $form->field($modelTarifa, 'nombre')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-md-4">
             <?= $form->field($modelTarifa, 'id_origen')->widget(Select2::classname(), [
    ...
    <div class="row">            
            ...
            <div class="panel panel-default">
                ...
                <div class="container-items"><!-- widgetContainer -->
                    <?php foreach ($modelTarifaDetallada as $index => $modeldetallada): ?>
                        <div class="item panel panel-default"><!-- widgetBody -->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <?= $form->field($modeldetallada, "[{$index}]adultos")->textInput(['maxlength' => true]) ?>
                                    </div>
                                    <div class="col-sm-4">
