	    ...
	    if (Yii::$app->request->get())
	    {
	        ...
	        if ((int) $id)
	        {
	            ...
	            if ($model->count() == 1)
	            {
	                ...
	                if ($activar->update())
	                {
	                    echo "Se ha registrado correctamente, redireccionando ...";
	  ...
	  if ($model->load(Yii::$app->request->post()))
	  {
	   if($model->validate())
	   {
	    ...
	    if ($table->insert())
	    {
	     ...
	     $body .= "<a href='http://localhost/Sistema-Hotel/web/site/index.php?r=site/confirm&id=".$id."&authKey=".$authKey."'>Confirmar</a>";
	    ...
	    {
	     $msg = "¡Ups! Ha ocurrido un error al llevar a cabo tu registro";
	    }
